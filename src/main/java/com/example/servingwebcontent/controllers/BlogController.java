...
public class BlogController {
    ...
    @GetMapping("/blog/add") //Получение из базы
    ...
    @PostMapping("/blog/add") // Добавление
    ...
    @GetMapping("/blog/{id}/edit") // Получение для редактирования
    ...
    @PostMapping("/blog/{id}/edit") // Редактирование
    ...
    @PostMapping("/blog/{id}/remove") // Удаление
